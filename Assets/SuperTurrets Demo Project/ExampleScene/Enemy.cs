...
public class Enemy : AbstractEnemy
{
	...
	{
		// Althought bullets use raycasting to collision with enemies, some bullets
		// can go throught enemy due to high velocity. We add this event to avoid this case.
		
		ExampleBullet bullet = targetCollider.GetComponent<ExampleBullet>();
		
		if(bullet != null)
		{
			bullet.Explode(targetCollider.transform.forward);
