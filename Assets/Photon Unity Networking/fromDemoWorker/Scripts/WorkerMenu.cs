...
public class WorkerMenu : MonoBehaviour
{
	...
	public static readonly string SceneNameMenu = "wulf-NateChanges";

	//public static readonly string SceneNameGame = "wulf-NateChanges 1";
    public static readonly string SceneNameGame = "terrain-only";
