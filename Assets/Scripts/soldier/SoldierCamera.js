...
class SoldierCamera extends MonoBehaviour
{
	...
	function Start () 
	{	
		// Set reference objects with _GameManager up.
		//GameObject.Find("/_GameManager/SoldierTargetHUD").GetComponent.<SoldierTarget>().soldierCam = GetComponent.<Camera>();
		//GameObject.Find("/_GameManager/SoldierTargetHUD").GetComponent.<SoldierTarget>().soldierCamera = this;
